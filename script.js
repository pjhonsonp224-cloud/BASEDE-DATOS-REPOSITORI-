document.addEventListener("DOMContentLoaded", function () {
  ...
  const semanas = [
    ...
    { label: "Semana 15", descripcion: "Microsoft SQL Azure - Administracion y desarrollo en la nube.", archivos: [{ nombre: "Resumen General", enlace: "archivos/semana 15 -1.pdf" },] }
     { label: "Semana 16", descripcion: "Microsoft SQL Azure - Administracion y desarrollo en la nube II .", archivos: [{ nombre: "Resumen General II", enlace: "archivos/semana 16 - 1.pdf" }] }
  ];
